...
`,
    ...
    tools: {
      addRFP: {
        ...
        parameters: z.object({
          label: z.string().describe('Label RFP generated by the AI-generated'),
          name: z.string().describe('Name RFP generated by the AI-generated'),
          summary: z.string().describe('Summary RFP generated by the AI-generated'),
          body: z.string().describe('Body Content RFP generated by the AI-generated'),
          deadline: z.string().describe('Unix timestamp with milliseconds deadline RFP generated by the AI-generated')
        }),
        generate: async function* ({ label, name, summary, body, deadline }) {
          yield (
            <BotCard>
              <AddRfpSkeleton />
            </BotCard>
                ...
                content: [
                  {
                    ...
                    toolName: 'addRFP',
                    toolCallId,
                    args: { label, name, summary, body, deadline }
                  }
                ]
              },
              {
                ...
                content: [
                  {
                    ...
                    toolName: 'addRFP',
                    toolCallId,
                    result: { label, name, summary, body, deadline }
                  }
                ]
              }
            ]
          ...
          return (
            <BotCard>
              <BotCard>
                <AddRFP props={{ label, name, summary, body, deadline }} />
              </BotCard>
            </BotCard>
          )
        }
