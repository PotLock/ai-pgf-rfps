...
`,
    ...
    tools: {
      addRFP: {
        description:
          'Get the content RFP generated by the AI-generated and save it to the API.',
        parameters: z.object({
          label: z.string().describe('Content RFP generated by the AI-generated'),
          body: z.string().describe('Content RFP generated by the AI-generated')
        }),
